...
function demoPolicyBean(o: pb.PoliceBeans.PolicyBean) {
    // console.info(o.flowNumber)
    // console.info(o.policyInfoBean)
    for (const f of o.fences) {
        // console.info(`fence: ${f}`)
        // console.info(JSON.stringify(f, null, 2))
        inspectFenceIfc(f)
    }
...
function inspectFenceIfc(o: pb.PoliceBeans.Fence) {
    console.info(o.fenceIndex)
    for (const fd of o.fenceDefinition) {
        inspectFenceDefineIfc(fd)
    }
}

function inspectFenceDefineIfc(o: pb.PoliceBeans.FenceDefinition) {
    console.info(`fenceIndex: ${o.ruleType}`)
    console.info(`isExternalAction: ${o.isExternalAction}`)

}

demoPolicyBean(objPolicyBean)

...
exports.objDataBean = exports.objFeedbackBean = exports.objPolicyBean = void 0;
const PdlCoder = __importStar(require("./pdlCoder"));
const ByteBuffer_1 = require("./ByteBuffer");
const PdlCoderUnitTest_1 = require("./PdlCoderUnitTest");
...
`;
exports.objFeedbackBean = JSON.parse(jsonFeedbackBean);
const jsonDataBean = `{
  "flowNumber": "setFlowNumber",
  "hash": "setHash",
  "algorithm": "setAlgorithm",
...
`;
exports.objDataBean = JSON.parse(jsonDataBean);
function testEncode() {
    let buffer = new ByteBuffer_1.ByteBuffer();
    PdlCoder.encPdlDataFrames(exports.objPolicyBean, '', buffer);
    // console.info(buffer.base64String());
}

function testEncodePdlFrame() {
    const base64 = PdlCoder.encPdlFrameBase64(1234, 0x1504, 1234, exports.objPolicyBean);
...
function testEncodeThenDecodePolicyBean() {
    ...
    (0, PdlCoderUnitTest_1.assertEncodeThenDecode)(results[0], exports.objPolicyBean, buffer);
    console.info('decode pass!');
}
function testEncodeThenDecodePolicyBeanPdlFrame() {
    const base64PdlFrame = PdlCoder.encPdlFrameBase64(1234, 0x1504, 1234, exports.objPolicyBean);
    const results = PdlCoder.decPdlFrameBase64(base64PdlFrame);
    if (!_.isEqual(results[0], exports.objPolicyBean)) {
        throw 'obj not equal!';
    }
...
function testDecodeFromJavaPdlFrame() {
    ...
    if (!_.isEqual(objects[0], exports.objPolicyBean)) {
        throw 'not equals';
    }
...
function testEncodeThenDecodeFeedbackBean() {
    let buffer = new ByteBuffer_1.ByteBuffer();
    PdlCoder.encPdlDataFrames(exports.objFeedbackBean, '', buffer);
    let results = PdlCoder.decPdlDataOrgJson(buffer);
    (0, PdlCoderUnitTest_1.assertEncodeThenDecode)(results[0], exports.objFeedbackBean, buffer);
    console.info('decode feedback bean pass!');
}
function testEncodeThenDecodeFeedbackBeanPdlFrame() {
    const base64PdlFrame = PdlCoder.encPdlFrameBase64(123, 0x1504, 1234, exports.objFeedbackBean);
    const objects = PdlCoder.decPdlFrameBase64(base64PdlFrame);
    if (!_.isEqual(exports.objFeedbackBean, objects[0])) {
        throw 'not equal';
    }
...
function testEncodeThenDecodeDataBean() {
    let buffer = new ByteBuffer_1.ByteBuffer();
    PdlCoder.encPdlDataFrames(exports.objDataBean, '', buffer);
    // console.info(buffer.base64String());
    let results = PdlCoder.decPdlDataOrgJson(buffer);
    (0, PdlCoderUnitTest_1.assertEncodeThenDecode)(results[0], exports.objDataBean, buffer);
    console.info('decode data bean bean pass!');
}
function testEncodeThenDecodeDataBeanPdlFrame() {
    const base64PdlFrame = PdlCoder.encPdlFrameBase64(123, 0x1504, 1234, exports.objDataBean);
    const objects = PdlCoder.decPdlFrameBase64(base64PdlFrame);
    if (!_.isEqual(exports.objDataBean, objects[0])) {
        throw 'not equal';
    }
